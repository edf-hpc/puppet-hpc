...
# @return A hash of hpc_backup::switches::cron
Puppet::Parser::Functions::newfunction(
  :hpc_backup_switches_crons,
  :type  => :rvalue,
  :arity => 2,
  :doc   =>
    "Return a hash of hpc_backup::switches::cron from sources and a target base dir"
) do |args|
  sources = args[0]
  base_target_dir = args[1]

  result = hpc_backup_switches_crons(sources, base_target_dir)
