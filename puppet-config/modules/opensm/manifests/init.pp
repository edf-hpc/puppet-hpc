...
# Deploys OpenSM Infiniband Subnet Manager
#
...
# @param packages List of packages for the OpenSM software (default: ['opensm])
...
# @param service_name Name of the service to manage (default: 'opensm')
...
class opensm (
  $install_manage          = $::opensm::params::install_manage,
  $packages_manage         = $::opensm::params::packages_manage,
  $packages                = $::opensm::params::packages,
  $packages_ensure         = $::opensm::params::packages_ensure,
  $service_manage          = $::opensm::params::service_manage,
  $service_name            = $::opensm::params::service_name,
  $service_ensure          = $::opensm::params::service_ensure,
  $service_enable          = $::opensm::params::service_enable,
